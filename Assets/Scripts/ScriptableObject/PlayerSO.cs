...
public class PlayerGroundData
{
    ...
    [field: SerializeField][field: Range(0f, 25f)] public float RunSpeedModifier { get; private set; } = 5f;
...
[CreateAssetMenuAttribute(fileName = "Player", menuName = "Characters/Player")]
